      ...
      <SheetContent className="overflow-y-auto pb-10">
        ...
        <div className="space-y-5 mt-6">
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Primary Muscles</Label>
          ...
          {/* Secondary Muscles */}
          <div className="space-y-2">
            <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Secondary Muscles</Label>
          ...
          {/* Movement Pattern */}
          <div className="space-y-2">
            <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Movement Pattern</Label>
            <div className="flex flex-wrap gap-1.5">
